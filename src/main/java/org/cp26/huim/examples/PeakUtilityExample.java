...
public final class PeakUtilityExample {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // String datasetPath = "data/test_dataset/tiny_manual_spmf.txt";     // Path to the dataset
        String datasetPath = "data/Data_SPMF/chess_utility_spmf.txt";     // Path to the dataset
      //  String datasetPath = "data/foodmart.txt";     // Path to the dataset
        int minUtil = 100000;                            // Minimum utility threshold
        ...
        boolean verbose = true;                        // Display details in console
        ...
        PropPeakUtility.Mode mode = PropPeakUtility.Mode.UPI;  // UPI = Peak Utility mode
        ...
        String valSel = "min";                          // min|max

        // Timeout configuration
        long timeoutMs = 0;                         // Timeout in milliseconds (60 sec = 60000)
